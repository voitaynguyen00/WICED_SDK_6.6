...
extern char adv_scanner_local_name[];
...
{
    (uint8_t*)adv_scanner_local_name,                              /**< Local device name (NULL terminated) */
    ...
    /* BLE scan settings  */
    {
        ...
        96,                 /**< High duty scan window */
        0,                  /**< High duty scan duration in seconds (0 for infinite) */

        96,                /**< Low duty scan interval  */
        96,                /**< Low duty scan window */
    ...
    /* GATT configuration */
    {
        ...
        512                                                         /**< Client config: maximum number of bytes that local client can reciver over LE link  */
    },
    ...
    {
        0,                                                          /**< 1 if AVRC_CONN_ACCEPTOR is supported */
