...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
    {
        ...
        .conn_min_interval               = 6,                                                        /**< Minimum connection interval */
        ...
        .gatt_cfg =                       /**< GATT settings */
            {
                ...
                .max_attr_len     = 0,   /**< Maximum attribute length; gki_cfg must have a corresponding buffer pool that can hold this length */
                .max_mtu_size     = 256
            },
