...
const uint8_t   gatt_server_db_device_name[]                        = {'A','N','C','S'};
...
uint8_t         ancs_device_information_manufacturer_name_string[]  = {'C','y','p','r','e','s','s'};
uint8_t         ancs_device_information_model_number_string[]       = {'B','L','E','-','1','0','3'};
uint8_t         ancs_device_information_firmware_revision_string[]  = {'1','.','0','.','0'};
uint8_t         ancs_device_information_software_revision_string[]  = {'1','.','0','.','1'};

/* GATT attribute lookup table                                */
/* (attributes externally referenced by GATT server database) */
gatt_db_lookup_table_t ancs_gatt_db_ext_attr_tbl[] =
{
    ...
    {HDLC_DEVICE_INFORMATION_MANUFACTURER_NAME_STRING_VALUE,                 sizeof(ancs_device_information_manufacturer_name_string), sizeof(ancs_device_information_manufacturer_name_string), ancs_device_information_manufacturer_name_string},
    {HDLC_DEVICE_INFORMATION_MODEL_NUMBER_STRING_VALUE,                      sizeof(ancs_device_information_model_number_string),      sizeof(ancs_device_information_model_number_string),      ancs_device_information_model_number_string},
    {HDLC_DEVICE_INFORMATION_FIRMWARE_REVISION_STRING_VALUE,                 sizeof(ancs_device_information_firmware_revision_string), sizeof(ancs_device_information_firmware_revision_string), ancs_device_information_firmware_revision_string},
    {HDLC_DEVICE_INFORMATION_SOFTWARE_REVISION_STRING_VALUE,                 sizeof(ancs_device_information_software_revision_string), sizeof(ancs_device_information_software_revision_string), ancs_device_information_software_revision_string},
};

const uint16_t ancs_gatt_db_ext_attr_tbl_size = (sizeof(ancs_gatt_db_ext_attr_tbl) / sizeof (gatt_db_lookup_table_t));
