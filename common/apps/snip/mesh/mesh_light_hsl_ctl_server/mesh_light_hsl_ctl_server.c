...
#endif
    WICED_BT_MESH_MODEL_LIGHT_HSL_CTL_SERVER,
};
...
void mesh_app_init(wiced_bool_t is_provisioned)
{
    ...
    wiced_bt_mesh_model_light_hsl_server_init(MESH_LIGHT_HSL_SERVER_ELEMENT_INDEX, mesh_light_hsl_server_message_handler, is_provisioned);
 ...
 */
void mesh_light_hsl_server_message_handler(uint8_t element_idx, uint16_t event, void *p_data)
{
