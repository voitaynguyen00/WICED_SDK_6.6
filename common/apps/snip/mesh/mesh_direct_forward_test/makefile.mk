...
########################################################################
APP_SRC = mesh_direct_forward_test.c
...
# uncomment next line to include directed forwarding code 
C_FLAGS += -DMESH_DIRECTED_FORWARDING_SUPPORTED
