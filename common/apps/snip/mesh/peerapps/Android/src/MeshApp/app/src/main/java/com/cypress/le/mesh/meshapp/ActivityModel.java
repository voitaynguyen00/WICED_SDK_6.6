...
public class ActivityModel extends AppCompatActivity implements LightingService.IServiceCallback{
    ...
    private ServiceConnection mConnection= new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName compname, IBinder service) {
            ...
            byte componentType = serviceReference.getMesh().getComponentType(name);
