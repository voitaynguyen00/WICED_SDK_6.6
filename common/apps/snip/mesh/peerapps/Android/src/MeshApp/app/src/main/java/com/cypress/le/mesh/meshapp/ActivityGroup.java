...
public class ActivityGroup extends AppCompatActivity implements LightingService.IServiceCallback {
    ...
    ArrayList<Byte> componentType = new ArrayList<Byte>();
    ...
    protected void onResume() {
        ...
        if(components.size()!= 0 ) {
            ...
            componentType = new ArrayList<Byte>();
        ...
        groupOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!transtime.getText().toString().matches(""))
                    ...
                    time = 0;
                serviceReference.getMesh().onoffSet(groupName, true, true,time, (short) 0);
        ...
        groupOff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!transtime.getText().toString().matches(""))
                    ...
                    time = 0;
                serviceReference.getMesh().onoffSet(groupName, false, true,time, (short) 0);
...
*/
    ...
    private void startScan() {
        Log.d(TAG, "startScan");
        serviceReference.getMesh().scanMeshDevices(true);
    }

    private void stopScan() {
        Log.d(TAG, "stopScan");
        serviceReference.getMesh().scanMeshDevices(false);
    }
