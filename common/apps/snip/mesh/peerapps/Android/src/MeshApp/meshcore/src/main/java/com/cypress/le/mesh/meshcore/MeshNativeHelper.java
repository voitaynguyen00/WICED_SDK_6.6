...
public class MeshNativeHelper {
    ...
    public static native byte meshClientGetComponentType(String componentName);
    ...
    public static native int meshClientVendorDataSet(String deviceName, byte[] buffer, short len);
    ...
    public static native void meshClientScanUnprovisioned(int start);
