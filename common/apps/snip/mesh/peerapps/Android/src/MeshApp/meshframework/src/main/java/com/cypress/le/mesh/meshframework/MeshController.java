...
public class MeshController {
    ...
    /**
     * Indicates the component is of type power on-off
     */
     ...
     */
    public byte getComponentType(String componentName) {
     ...
     */
    public boolean scanMeshDevices(boolean start) {
        Log.d(TAG,"scanMeshDevices");
        if (isServiceConnected()) {
            return service.scanMeshDevices(start);
        }
        return false;
    }
    ...
    int vendorDataSend(String deviceName, byte[] buffer, short len)
    {
        Log.d(TAG,"vendorDataSend");
        if (isServiceConnected()) {
            return service.vendorDataSet(deviceName, buffer, len);
        }
