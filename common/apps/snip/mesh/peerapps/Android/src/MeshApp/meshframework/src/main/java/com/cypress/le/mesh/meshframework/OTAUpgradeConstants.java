...
class OTAUpgradeConstants {
    ...
    public OTAUpgradeConstants() {
        ...
        {
            UPGRADE_SERVICE_UUID = UUID.fromString("10022922-ccf5-11e8-b680-025041000001");
            SECURE_UPGRADE_SERVICE_UUID = UUID.fromString("10270b52-ccf5-11e8-8c28-025041000001");
            UPGRADE_CHARACTERISTIC_CONTROL_POINT_UUID = UUID.fromString("1058fcfc-ccf5-11e8-b112-025041000001");
            UPGRADE_CHARACTERISTIC_DATA_UUID = UUID.fromString("107163c8-ccf5-11e8-9b81-025041000001");
        } else {
