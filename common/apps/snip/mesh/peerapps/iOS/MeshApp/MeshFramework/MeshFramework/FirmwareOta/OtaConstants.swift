...
public struct MeshDfuType {
    ...
    static public let PROXY_DFU_TO_DEVICE = 1
    static public let APP_DFU_TO_ALL = 2
    static public let APP_DFU_TO_DEVICE = 3
    static public let DFU_TYPE_TEXT_MAP: [Int: String] = [MeshDfuType.PROXY_DFU_TO_ALL: "Proxy DFU to all",
                                                          MeshDfuType.PROXY_DFU_TO_DEVICE: "Proxy DFU to device",
                                                          MeshDfuType.APP_DFU_TO_ALL: "App DFU to all",
                                                          MeshDfuType.APP_DFU_TO_DEVICE: "App DFU to device"]
    static public var DFU_TYPE_TEXT_LIST: [String] {
        return Array(MeshDfuType.DFU_TYPE_TEXT_MAP.values)
    }
