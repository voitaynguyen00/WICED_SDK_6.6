...
{
public:
    WSDownloader(CBtInterface *pBtInterface, LPBYTE pPatch, DWORD dwPatchSize, DWORD dwPatchCid, BYTE *pPatchId, HWND hWnd);
...
private:
    ...
    DWORD m_crc32;
    DWORD m_PatchCid;
    BYTE  m_PatchId[PATCH_ID_LENGTH];
};
