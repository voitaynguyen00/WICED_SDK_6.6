...
#define HCI_CONTROL_MESH_EVENT_VENDOR_SET                                   ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0xff )  /* Vendor model data */
#define HCI_CONTROL_MESH_EVENT_VENDOR_STATUS                                ( ( HCI_CONTROL_GROUP_MESH << 8 ) | 0xff )  /* Vendor model data */
