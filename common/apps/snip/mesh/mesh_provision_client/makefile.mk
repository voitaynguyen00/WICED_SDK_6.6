...
#C_FLAGS += -DPTS
C_FLAGS += -DREMOTE_PROVISIONG_SERVER_SUPPORTED

########################################################################
# Mesh models enabled in mesh_provision_client
########################################################################
...
C_FLAGS += -DWICED_BT_MESH_MODEL_DEFAULT_TRANSITION_TIME_CLIENT_INCLUDED
...
########################################################################
APP_SRC = mesh_provision_client.c
