...
wiced_bt_mesh_core_config_model_t   mesh_element1_models[] =
{
    ...
    WICED_BT_MESH_MODEL_LEVEL_SERVER,
};
...
void mesh_app_init(wiced_bool_t is_provisioned)
{
    ...
    wiced_bt_cfg_settings.device_name = (uint8_t *)"Level Server";
 ...
 */
void mesh_level_server_message_handler(uint8_t element_idx, uint16_t event, void *p_data)
{
    switch (event)
    {
    ...
    default:
        WICED_BT_TRACE("level srv unknown msg:%d\n", event);
        break;
    }
}
