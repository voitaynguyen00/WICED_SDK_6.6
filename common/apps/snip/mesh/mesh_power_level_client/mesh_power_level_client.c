 ...
 *          Constants
 ******************************************************/
#define MESH_PID                0x3017
#define MESH_VID                0x0002
#define MESH_FWID               0x3017000101010001
...
static void mesh_power_level_client_message_handler(uint16_t event, wiced_bt_mesh_event_t *p_event, void *p_data);
...
#define MESH_POWER_LEVEL_CLIENT_ELEMENT_INDEX   0
