...
static void mesh_light_xyl_client_message_handler(uint16_t event, wiced_bt_mesh_event_t *p_event, void *p_data);
...
#define MESH_LIGHT_XYL_CLIENT_ELEMENT_INDEX   0
...
{
    wiced_bt_cfg_settings.device_name = (uint8_t *)"XYL Control";
    ...
    wiced_bt_mesh_model_light_xyl_client_init(MESH_LIGHT_XYL_CLIENT_ELEMENT_INDEX, mesh_light_xyl_client_message_handler, is_provisioned);
}
