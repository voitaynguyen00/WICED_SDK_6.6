...
const wiced_bt_cfg_settings_t app_cfg_settings =
{
    ...
    .max_number_of_buffer_pools         = 4,                                                         // Maximum number of buffer pools
    .rpa_refresh_timeout                = WICED_BT_CFG_DEFAULT_RANDOM_ADDRESS_NEVER_CHANGE,          // Interval of  random address refreshing
#endif
...
#if ( defined(CYW20735B0) || defined(CYW20721B1) )
    .def_ble_pwr_level                  = 12,                                                             /**< Max. power level of the device */
#endif

#if defined(CYW20735B1) || defined(CYW43012C0) || defined(CYW20819A1)
