 ...
 *  2. Connect device wake pin to prevent chip enter to sleep.
 *     (Please refer hci_control_sleep_config.device_wake_gpio_num or refer BT_DEV_WAKE in 20706 Hardware user guide)
...
#if ( defined(CYW20719B1) || defined(CYW20721B1) || defined(WICEDX) || defined(CYW20819A1) )
...
#ifdef CYW20719B1
        hci_control_sleep_config.device_wake_gpio_num   = WICED_P00;
#else
