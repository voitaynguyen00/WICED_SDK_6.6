 ...
 ****************************************************************************/
const uint8_t opp_server_sdp_db[] = // Define SDP database
{
    SDP_ATTR_SEQUENCE_1(92),                                                 // length is the sum of all records

    // SDP Record for opp_server
    SDP_ATTR_SEQUENCE_1(75),                                                 // 2 bytes, length of the record
        SDP_ATTR_RECORD_HANDLE(HDLR_OPP_SERVER_UNIT),                        // 8 bytes
        SDP_ATTR_ID(ATTR_ID_SERVICE_CLASS_ID_LIST),                          // 3 bytes
        SDP_ATTR_SEQUENCE_1(3),                                              // 2 bytes
        SDP_ATTR_UUID16(UUID_SERVCLASS_OBEX_OBJECT_PUSH),                    // 3 bytes
        ...
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_VCARD21_FMT),                       // 2 bytes
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_VCARD30_FMT),                       // 2 bytes
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_VCAL_FMT),                          // 2 bytes
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_ICAL_FMT),                          // 2 bytes
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_VNOTE_FMT),                         // 2 bytes
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_VMSG_FMT),                          // 2 bytes
        SDP_ATTR_VALUE_UINT1(WICED_BT_OP_OTHER_FMT),                         // 2 bytes
};
 ...
 *****************************************************************************/
const wiced_bt_cfg_buf_pool_t opp_server_cfg_buf_pools[] =
{
/*  { buf_size, buf_count } */
    { 64,      12  },      /* Small Buffer Pool */
    { 600,      40 },      /* Medium Buffer Pool (used for HCI & RFCOMM control messages, min recommended size is 360) */
...
{
    return (uint16_t)sizeof(opp_server_cfg_buf_pools);
}
