...
$(NAME)_COMPONENTS += ambient_light_sensor_lib.a
$(NAME)_COMPONENTS += pir_motion_sensor_lib.a
# ifeq ($(PLATFORM),CYBT_213043_MESH)
ifneq (,$(findstring CYBT_213043_MESH,$(PLATFORM_FULL)))
$(NAME)_COMPONENTS += thermistor_ncp15xv103_lib.a
else
$(NAME)_COMPONENTS += thermistor_ncu15wf104_lib.a
endif
