...
const uint8_t gatt_server_db[] = // Define GATT database
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_SERIAL_GATT, __UUID_SERIAL_GATT_SERVICE),
        ...
        CHARACTERISTIC_UUID128_WRITABLE (HDLC_SERIAL_GATT_SERIAL_DATA, HDLC_SERIAL_GATT_SERIAL_DATA_VALUE,
            __UUID_SERIAL_GATT_SERIAL_DATA, LEGATTDB_CHAR_PROP_WRITE_NO_RESPONSE | LEGATTDB_CHAR_PROP_NOTIFY,
...
const uint8_t gatt_server_db_device_name[] = {'B','o','s','o','n'};
const uint16_t gatt_server_db_device_name_len = sizeof(gatt_server_db_device_name);

const uint8_t gatt_server_db_appearance[] = { BIT16_TO_8(APPEARANCE_WATCH_SPORTS) };
const uint16_t gatt_server_db_appearance_len = sizeof(gatt_server_db_appearance);

uint8_t watch_battery_service_battery_level[]                                     = {0x64};
uint8_t watch_device_information_manufacturer_name_string[]                       = {'C','y','p','r','e','s','s'};
uint8_t watch_device_information_model_number_string[]                            = {'B','L','E',0x2d,'1','0','1'};
uint8_t watch_device_information_firmware_revision_string[]                       = {'1',0x2e,'0',0x2e,'0'};
uint8_t watch_device_information_software_revision_string[]                       = {'1',0x2e,'0',0x2e,'1'};
uint8_t serial_gatt_service_serial_data_client_configuration[]                    = {BIT16_TO_8(GATT_CLIENT_CONFIG_NONE)};

/* GATT attribute lookup table                                */
/* (attributes externally referenced by GATT server database) */
gatt_db_lookup_table watch_gatt_db_ext_attr_tbl[] =
{
    /* { attribute handle,                                                   maxlen,                                          curlen,                                          attribute data } */
    {HDLC_GENERIC_ACCESS_DEVICE_NAME_VALUE,                                  5,                                               5,                                               (uint8_t *)gatt_server_db_device_name},
    {HDLC_GENERIC_ACCESS_APPEARANCE_VALUE,                                   2,                                               2,                                               (uint8_t *)gatt_server_db_appearance},
    {HDLC_BATTERY_SERVICE_BATTERY_LEVEL_VALUE,                               1,                                                         1,                                                         watch_battery_service_battery_level},
    {HDLC_DEVICE_INFORMATION_MANUFACTURER_NAME_STRING_VALUE,                 sizeof(watch_device_information_manufacturer_name_string), sizeof(watch_device_information_manufacturer_name_string), watch_device_information_manufacturer_name_string},
    {HDLC_DEVICE_INFORMATION_MODEL_NUMBER_STRING_VALUE,                      sizeof(watch_device_information_model_number_string),      sizeof(watch_device_information_model_number_string),      watch_device_information_model_number_string},
    {HDLC_DEVICE_INFORMATION_FIRMWARE_REVISION_STRING_VALUE,                 sizeof(watch_device_information_firmware_revision_string), sizeof(watch_device_information_firmware_revision_string), watch_device_information_firmware_revision_string},
    {HDLC_DEVICE_INFORMATION_SOFTWARE_REVISION_STRING_VALUE,                 sizeof(watch_device_information_software_revision_string), sizeof(watch_device_information_software_revision_string), watch_device_information_software_revision_string},
};

const uint16_t watch_gatt_db_ext_attr_tbl_size = ( sizeof ( watch_gatt_db_ext_attr_tbl ) / sizeof ( gatt_db_lookup_table ) );
