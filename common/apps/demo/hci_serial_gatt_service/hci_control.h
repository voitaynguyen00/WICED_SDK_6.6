...
#define BTA_HS_SCO_PKT_TYPES    ( BTM_SCO_LINK_ALL_PKT_MASK       | \
...
extern void     serial_gatt_service_app_init(void);
...
extern uint32_t serial_gatt_service_process_wiced_hci_command(uint16_t opcode, uint8_t *p_tx_buffer,uint16_t offset, uint32_t length);
extern void     hci_control_misc_handle_command( uint16_t cmd_opcode, uint8_t* p_data, uint32_t data_len );


extern uint32_t                serial_gatt_service_process_wiced_hci_command(uint16_t opcode, uint8_t *p_tx_buffer,uint16_t offset, uint32_t length);
extern void                    serial_gatt_service_connection_up(wiced_bt_gatt_connection_status_t *p_conn_status);
extern void                    serial_gatt_service_connection_down(wiced_bt_gatt_connection_status_t *p_conn_status);
extern wiced_bt_gatt_status_t  serial_gatt_service_read_handler(uint16_t conn_id, wiced_bt_gatt_read_t *p_read_req);
extern wiced_bt_gatt_status_t  serial_gatt_service_write_handler(uint16_t conn_id, wiced_bt_gatt_write_t *p_write_req);
extern wiced_bt_gatt_status_t  serial_gatt_service_mtu_handler(uint16_t conn_id, uint16_t mtu);
extern void                    hci_control_misc_handle_command( uint16_t cmd_opcode, uint8_t* p_data, uint32_t data_len );
