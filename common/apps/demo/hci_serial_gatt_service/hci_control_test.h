...
#ifndef STAGING_BT_SDK_APPS_BOSON_HCI_CONTROL_TEST_H_
#define STAGING_BT_SDK_APPS_BOSON_HCI_CONTROL_TEST_H_
...
#endif /* STAGING_BT_SDK_APPS_BOSON_HCI_CONTROL_TEST_H_ */
