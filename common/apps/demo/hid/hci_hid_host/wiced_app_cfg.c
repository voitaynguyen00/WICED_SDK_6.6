...
#define WICED_DEVICE_NAME                       "Wiced HID Host"
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    {
        .scan_mode                       = BTM_BLE_SCAN_MODE_NONE,                                   // BLE scan mode (BTM_BLE_SCAN_MODE_PASSIVE, BTM_BLE_SCAN_MODE_ACTIVE, or BTM_BLE_SCAN_MODE_NONE)
    ...
    .l2cap_application =                                                                             // Application managed l2cap protocol configuration
    {
        ...
        .max_channels                   = 6,                                                         // Maximum number of application-managed BR/EDR channels
