...
wiced_platform_gpio_t platform_gpio_pins[] =
    {
        ...
        [PLATFORM_GPIO_1 ] = {WICED_P01, WICED_GPIO       },      //Button
        ...
        [PLATFORM_GPIO_10] = {WICED_P25, WICED_GPIO       },      //LED 2
...
/* LED configuration */
wiced_platform_led_config_t platform_led[] =
    {

    };

size_t led_count = (sizeof(platform_led) / sizeof(wiced_platform_led_config_t));
...
size_t button_count = (sizeof(platform_button) / sizeof(wiced_platform_button_config_t));
