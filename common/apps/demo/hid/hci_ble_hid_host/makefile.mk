...
APP_SRC += hci_control_ble_hidh.c
APP_SRC += wiced_le_gatt.c

########################################################################
# Component(s) needed
########################################################################
$(NAME)_COMPONENTS := ble_hidh_lib.a
$(NAME)_COMPONENTS += ble_hidh_audio_lib.a
$(NAME)_COMPONENTS += gatt_utils_lib.a

########################################################################
# C flags
# To use SPI transport, append _SPI to the make target,
# for example "watch-BCM920706_P49_SPI download"
########################################################################
