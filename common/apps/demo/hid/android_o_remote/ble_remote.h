...
#define KBAPP_CLIENT_CONFIG_NOTIF_ATV_VOICE_RX      (1 << KBAPP_CLIENT_CONFIG_NOTIF_ATV_VOICE_RX_BIT_OFFSET)

#define KBAPP_CLIENT_CONFIG_NOTIF_ATV_VOICE_CTL_BIT_OFFSET   7
#define KBAPP_CLIENT_CONFIG_NOTIF_ATV_VOICE_CTL    (1 << KBAPP_CLIENT_CONFIG_NOTIF_ATV_VOICE_CTL_BIT_OFFSET)
