...
# OTA is not supported for 43012 device
...
# Component(s) needed
########################################################################
$(NAME)_COMPONENTS := beacon_lib.a
ifneq ($(CHIP), 43012)
$(NAME)_COMPONENTS += fw_upgrade_lib.a
endif
ifeq ($(CHIP), 43012)
$(NAME)_COMPONENTS += multi_adv_lib.a
endif

########################################################################
# C flags
########################################################################
C_FLAGS += -DOTA_CHIP=$(CHIP)
C_FLAGS += -DCHIP_REV_$(BLD)=1
C_FLAGS += -DWICED_BT_TRACE_ENABLE

ifeq ($(CHIP),20703)
ifeq ($(USE_256K_SECTOR_SIZE),1)
C_FLAGS += -DUSE_256K_SECTOR_SIZE
endif
endif
