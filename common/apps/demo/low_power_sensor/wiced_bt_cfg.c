...
{
    (uint8_t*)"low_power_sensor",                                   /**< Local device name (NULL terminated) */
    ...
    /* BLE advertisement settings */
    {
        ...
        2048,                                                       /**< Low duty undirected connectable minimum advertising interval */
        2048,                                                       /**< Low duty undirected connectable maximum advertising interval */
    ...
    5,                                                              /**< LE Address Resolution DB settings*/
