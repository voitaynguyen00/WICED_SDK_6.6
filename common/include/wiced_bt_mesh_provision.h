...
#define WICED_BT_MESH_AD_FILTER_TYPES_MAX   7
    uint8_t  ad_filter_types[WICED_BT_MESH_AD_FILTER_TYPES_MAX];  /**< AD Types to be reporte */
...
typedef struct
{
    ...
    uint8_t  phase;                     /**< The Remote Provisioning Scanning Server Phase value */
    uint8_t  scanned_items_limit;       /**< Maximum number of the scanned items to be reported */
    uint8_t  timeout;                   /**< Time limit for a scan(in seconds) */
    uint8_t  scanning_type;             /**< Remote Provisioning Scanning Type state value */
...
typedef struct
{
    ...
    uint8_t  uuid[16];                  /**< Value of the Device UUID */
    uint8_t  adv_data[1];               /**< Variable length ADV data for the UUID */
