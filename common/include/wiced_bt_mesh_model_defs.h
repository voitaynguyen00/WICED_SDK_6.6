...
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_INFO_GET                         0x8058
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_INFO_STATUS                      0x8059
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_LINK_GET                         0x805A
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_LINK_OPEN                        0x805B
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_LINK_CLOSE                       0x805C
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_LINK_STATUS                      0x805D
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_LINK_REPORT                      0x805F
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_PDU_SEND                         0x8060
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_PDU_OUTBOUND_REPORT              0x8061
#define WICED_BT_MESH_CODE_REMOTE_PROVISIONING_PDU_REPORT                       0x8062
...
#define WICED_BT_MESH_REMOTE_PROVISION_SCANNING_PHASE_IDLE              0x00
#define WICED_BT_MESH_REMOTE_PROVISION_SCANNING_PHASE_SCANNING          0x01
...
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_SCAN_CANNOT_RESTART       0x02    /**< Scanning Cannot Restart  */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_INVALID_STATE             0x03    /**< Invalid State */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_LINK_CANNOT_OPEN          0x04    /**< Link Cannot Open */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_WRONG_BEARER              0x05    /**< Wrong Bearer */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_LINK_OPEN_FAILED          0x06    /**< Link Open Failed */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_LINK_CLOSED_BY_DEVICE     0x07    /**< Link Closed by device */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_LINK_CLOSED_BY_SERVER     0x08    /**< Link Closed by server */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_LINK_CLOSED_BY_CLIENT     0x09    /**< Link Closed by client */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_PDU_CANNOT_TRANSFER       0x0A    /**< Provisioning PDU Cannot Transfer */
#define WICED_BT_MESH_REMOTE_PROVISION_STATUS_PDU_DELIVERED             0x0B    /**< Provisioning PDU Delivered */

#define WICED_BT_MESH_REMOTE_PROVISIONING_CLOSE_REASON_SUCCESS          0x00    /**< The operation completed successfully. */
#define WICED_BT_MESH_REMOTE_PROVISIONING_CLOSE_REASON_PROHISBITED      0x01    /**< Prohibited */
