...
// SerialGatt.h : main header file for the PROJECT_NAME application
//
...
// CSerialGattApp:
// See SerialGatt.cpp for the implementation of this class
//

class CSerialGattApp : public CWinApp
{
public:
    CSerialGattApp();
...
#define WM_SERIAL_DATA                  (WM_USER + 102)
...
extern GUID guidSvcSerialGatt; 
extern GUID guidCharSerialGatt;
