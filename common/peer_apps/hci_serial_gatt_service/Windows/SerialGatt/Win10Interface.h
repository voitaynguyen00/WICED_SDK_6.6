...
#include <wrl\event.h>
#include <stdio.h>
#include <../../10.0.17763.0/winrt/windows.devices.bluetooth.h>
#include <../../10.0.17763.0/winrt/windows.devices.bluetooth.advertisement.h>
#include <../../10.0.17763.0/winrt/windows.devices.bluetooth.genericattributeprofile.h>
#include <memory>
#include <functional>
...
public:
    ...
    BOOL FindChar(GUID uuid, USHORT inx, PBTH_LE_GATT_CHARACTERISTIC pOutChar);
    UINT16 GetMTUSize();
