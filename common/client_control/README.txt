...
3. In the Eclipse IDE, double-click on the desired target in 'Make Target' window
   to build and download an embedded application (local app) to the WICED
   evaluation board.
...
1. The highest baud rate supported in Mac xOS is 3,000,000 so all WICED embedded
   ...
   use a baud rate of 3,000,000. (See the baud rate specified in the
   wiced_transport_cfg_t structure of the embedded application.)
...
- Patch file download
  ...
  built using a make target with the 'build' command and setting the make target
  flag DIRECT_LOAD=1.  For example:
  "demo.hci_hid_device-CYW920706WCDEVAL DIRECT_LOAD=1 build"
  This produces a patch (.hcd) file in the build\<app-name>\ folder containing
  the embedded application.
  *** NOTE *** 20719/20819 devices do not support the DIRECT_LOAD option.
...
+++++++++++++++++++++++
Setup: Local apps - 20706-A2, 20719-B1, 20819-A1 - 'watch'.
...
+++++++++++++++++++++++
Setup: Local apps - 20706-A2, 20719-B1, 20819-A1 - 'watch', 'hci_audio_remote_control'.
Peer device - headset, speaker, car-kit
- Connect
...
Audio Gateway:
++++++++++++++
Setup: Local apps - 20706-A2 'hci_audio_gateway'
...
Hands-free:
+++++++++++
Setup: Local apps - 20706-A2 'hci_handsfree'
...
HID Host:
+++++++++
Setup: Local apps - 20706-A2, 20719-B1 - 'hci_hid_host' for BR-EDR or 
...
HID Device:
++++++++++
Setup: Local apps - 20706-A2, 20719-B1, 20819-A1 - 'hci_hid_device' for BR-EDR or
...
Phonebook Client
++++++++++++++++
WICED Platforms : 20706-A2, 20719-B1, 43012-C0
