...
gatt_uuid16_service_desc_t gatt_uuid16_service_desc[] =
{
...
gatt_uuid128_service_desc_t gatt_uuid128_service_desc[] =
{
...
void MainWindow::on_btnHelpGATT_clicked()
{
    ...
    Log("GATT help topic:");
    Log("");
    Log("WICED Platforms : 20706-A2, 20719-B1, 20819-A1");
    Log("Apps : watch");
