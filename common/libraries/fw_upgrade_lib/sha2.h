 ...
 * \param is224    0 = use SHA256, 1 = use SHA224
 */
void sha2( unsigned char *input, size_t ilen,
 ...
 * \param is224    0 = use SHA256, 1 = use SHA224
 */
void sha2_hmac_starts( sha2_context *ctx, unsigned char *key, size_t keylen,
                       int is224 );
 ...
 * \param ilen     length of the input data
 */
void sha2_hmac_update( sha2_context *ctx, unsigned char *input, size_t ilen );
 ...
 * \param is224    0 = use SHA256, 1 = use SHA224
 */
void sha2_hmac( unsigned char *key, size_t keylen,
