...
/** @file
 * Defines STM32L4xx default unhandled ISR and default mappings to unhandled ISR
 */
#include <stdint.h>
...
PLATFORM_SET_DEFAULT_ISR( PVD_PVM_irq            , UnhandledInterrupt )
...
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel1_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel2_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel3_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel4_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel5_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel6_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA1_Channel7_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( ADC1_2_irq             , UnhandledInterrupt )
...
PLATFORM_SET_DEFAULT_ISR( TIM1_BRK_TIM15_irq     , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TIM1_UP_TIM16_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TIM1_TRG_COM_TIM17_irq , UnhandledInterrupt )
...
PLATFORM_SET_DEFAULT_ISR( DFSDM1_FLT3_irq        , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TIM8_BRK_irq           , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TIM8_UP_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TIM8_TRG_COM_irq       , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TIM8_CC_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( ADC3_irq               , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( FMC_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( SDMMC1_irq             , UnhandledInterrupt )
...
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel1_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel2_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel3_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel4_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel5_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DFSDM1_FLT0_irq        , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DFSDM1_FLT1_irq        , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DFSDM1_FLT2_irq        , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( COMP_irq               , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( LPTIM1_irq             , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( LPTIM2_irq             , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( OTG_FS_irq             , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel6_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DMA2_Channel7_irq      , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( LPUART1_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( QUADSPI_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( I2C3_EV_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( I2C3_ER_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( SAI1_irq               , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( SAI2_irq               , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( SWPMI1_irq             , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( TSC_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( LCD_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( RNG_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( FPU_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( CRS_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( I2C4_EV_irq            , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( I2C4_ER_irq            , UnhandledInterrupt )
...
PLATFORM_SET_DEFAULT_ISR( DMA2D_irq              , UnhandledInterrupt )
