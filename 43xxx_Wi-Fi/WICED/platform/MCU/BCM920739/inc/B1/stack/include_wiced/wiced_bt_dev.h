...
typedef struct
{
    ...
    BT_OCTET16 randomizer; /**< randomizer */
    BT_OCTET16 commitment; /**< commitment */
    wiced_bt_ble_address_t    addr_rcvd_from; /**< peer address */
...
{
    wiced_bt_device_address_t   bd_addr;                /**< [in] BD Address of remote   */
    wiced_bt_dev_io_cap_t       local_io_cap;           /**< IO capabilities (to be filled by application callback) */
 ...
 * @param[in]       p_cback           : Result callback (wiced_bt_dev_vendor_specific_command_complete_params_t will be passed to the callback)
 *
 * @return
 *
 *                  WICED_BT_SUCCESS:        If successful
 ...
 *
 * Note :  Callback function argument will be wiced_bt_lq_stats_result_t structure pointer.
 *
