...
include platforms/$(subst .,/,$(PLATFORM))/normal_image_defines.mk
...
ifeq ($(JLINK_NATIVE), 1)
	...
	$(QUIET)$(call CONV_SLASHES,$(OPENOCD_FULL_NAME)) -f $(OPENOCD_PATH)$(JTAG).cfg -f $(OPENOCD_PATH)$(HOST_OPENOCD).cfg -f apps/waf/sflash_write/sflash_write.tcl -c "sflash_write_file $(XIP_OUTPUT_FILE) $(XIP_LOAD_ADDRESS) $(PLATFORM_BUS) 0 43909" -c shutdown $(DOWNLOAD_LOG) 2>&1
endif
