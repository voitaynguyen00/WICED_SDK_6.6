...
platform_mcu_suspend( void )
{
    ...
    WICED_SLEEP_CALL_EVENT_HANDLERS( permission, ( powersave_mcu_mode ==  PLATFORM_MCU_POWERSAVE_MODE_DEEP_SLEEP ?  WICED_LOW_POWER_DEEP_SLEEP : WICED_LOW_POWER_SLEEP), WICED_SLEEP_EVENT_ENTER, &result );
    ...
    WICED_SLEEP_CALL_EVENT_HANDLERS( permission, ( powersave_mcu_mode ==  PLATFORM_MCU_POWERSAVE_MODE_DEEP_SLEEP ?  WICED_LOW_POWER_DEEP_SLEEP : WICED_LOW_POWER_SLEEP), WICED_SLEEP_EVENT_CANCEL, &result );
}
