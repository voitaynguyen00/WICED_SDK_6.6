...
WEAK platform_result_t platform_hwcrypto_execute( crypto_cmd_t cmd )
{
    ...
    */
    ...
    if ( (aligned_buffers.hash_output_byte_count != 0) && (cmd.hash_output != NULL) )
    {
 ...
 */
WEAK platform_result_t platform_hwcrypto_aescbc_decrypt_sha256_hmac(uint8_t* crypt_key, uint8_t* crypt_iv, uint32_t crypt_size,
...
WEAK platform_result_t platform_hwcrypto_sha256_hmac( uint8_t *hmac_key, uint32_t keysize, uint8_t *source, uint32_t size,
