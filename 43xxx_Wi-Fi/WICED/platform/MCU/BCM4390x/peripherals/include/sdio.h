...
/* SDIO ACommands */
#define SDIOH_ACMD_PREFIX	(1<<31)
#define SDIOH_ACMD_6		(SDIOH_ACMD_PREFIX | 6)
#define SDIOH_ACMD_41		(SDIOH_ACMD_PREFIX | 41)
#define SDIOH_ACMD_51       (SDIOH_ACMD_PREFIX | 51)
...
#define SCR_REGISTER_LEN                8

#define SCR_STURCTURE_SHIFT             4
#define SCR_STRUCTURE_MASK              (0xF << SCR_STRUCTURE_MASK)
#define GET_SCR_STRUCTURE(val)          (((val) & SCR_STRUCTURE_MASK) >> SCR_STURCTURE_SHIFT)
#define SCR_SD_SPEC_SHIFT               0
#define SCR_SD_SPEC_MASK                (0xF << SCR_SD_SPEC_SHIFT)
#define GET_SD_SPEC(val)                (((val) & SCR_SD_SPEC_MASK) >> SCR_SD_SPEC_SHIFT)
#define SCR_CMD23_BIT                   (0x1 << 25)
#define SCR_CMD20_BIT                   (0x1 << 24)
#define SCR_CMD23_SUPPORT(val)          (((val) & SCR_CMD23_BIT) != 0)
#define SCR_CMD20_SUPPORT(val)          (((val) & SCR_CMD20_BIT) != 0)
