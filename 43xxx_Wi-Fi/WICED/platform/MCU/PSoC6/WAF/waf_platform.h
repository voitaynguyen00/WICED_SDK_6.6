...
#define SECTOR_SIZE_COPY    (1)      // Do sector aligned copy operations
...
#define FLASH_ADDR_MASK     (/* e.g. 0x007FFFFF */)
...
#define PLATFORM_APP_INT_START_SECTOR        ( /* e.g. FLASH_Sector_3 */ )
#define PLATFORM_APP_INT_END_SECTOR          ( /* e.g. FLASH_Sector_5 */ )
#endif

#define PLATFORM_SFLASH_PERIPHERAL_ID        (/* e.g. 0 */)
#else
...
#define PLATFORM_DCT_COPY1_START_SECTOR      ( /* e.g. FLASH_Sector_1 */  )
#define PLATFORM_DCT_COPY1_START_ADDRESS     ( DCT1_START_ADDR )
#define PLATFORM_DCT_COPY1_END_SECTOR        ( /* e.g. FLASH_Sector_1 */ )
#define PLATFORM_DCT_COPY1_END_ADDRESS       ( DCT1_START_ADDR + DCT1_SIZE )
#define PLATFORM_DCT_COPY2_START_SECTOR      ( /* e.g. FLASH_Sector_2 */ )
#define PLATFORM_DCT_COPY2_START_ADDRESS     ( DCT2_START_ADDR )
#define PLATFORM_DCT_COPY2_END_SECTOR        ( /* e.g. FLASH_Sector_2 */ )
 ...
 * @param   led_index        - wiced_led_index_t (generic led index, see platforms/<platform>/platform.c for table)
 *
