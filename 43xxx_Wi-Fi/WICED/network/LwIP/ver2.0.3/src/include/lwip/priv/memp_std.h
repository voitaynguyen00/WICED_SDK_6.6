...
LWIP_PBUF_MEMPOOL(PBUF_POOL_TX, PBUF_POOL_TX_SIZE,           PBUF_POOL_BUFSIZE,             "PBUF_POOL_TX")
LWIP_PBUF_MEMPOOL(PBUF_POOL_RX, PBUF_POOL_RX_SIZE,           PBUF_POOL_BUFSIZE,             "PBUF_POOL_RX")
LWIP_PBUF_MEMPOOL(PBUF_POOL_LARGE, PBUF_POOL_LARGE_SIZE,     PBUF_POOL_LARGE_BUFSIZE,       "PBUF_POOL_LARGE")
