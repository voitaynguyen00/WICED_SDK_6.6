...
/*                                            new service, define NX_RAND,*/
/*                                            fixed a bug when conflict   */
/*                                            ARP packet is received,     */
/*                                            resulting in version 5.8    */
/*  02-22-2016     Yuxin Zhou               Modified comment(s), and      */
/*                                            removed check that IGMPv2 is*/
/*                                            disabled, unified ticks per */
/*                                            second, supported TCP fast  */
/*                                            retransmission, supported   */
/*                                            link status change          */
/*                                            notification, supported     */
/*                                            IP packet filter, removed   */
/*                                            unused code, renamed        */
/*                                            symbols, added a macro to   */
/*                                            disable warning of parameter*/
/*                                            not used, resulting in      */
/*                                            version 5.9                 */
/*  05-10-2016     Yuxin Zhou               Modified comment(s), and      */
/*                                            supported ARP probe for all */
/*                                            interfaces,                 */
...
/*                                            high security build option, */
/*                                            fixed system state check,   */
/*                                            improved string length check*/
...
#define NETX_MAJOR_VERSION    5
#define NETX_MINOR_VERSION    12
