...
/*  DESCRIPTION                                                           */ 
/*                                                                        */ 
/*    This file defines the NetX File Transfer Protocol component,        */ 
...
/*                                            added event to stop FTP,    */
/*                                            resulting in version 5.9    */
/*  05-10-2016     Yuxin Zhou               Modified comment(s),          */
/*                                            renamed _nx_ftp_server_     */
/*                                            control_disonnect_processing*/
/*                                            to nx_ftp_server_control_   */
/*                                            disconnect_processing,      */
/*                                            resulting in version 5.10   */
/*  07-15-2018     Janet Christiansen       Modified comment(s), and      */
/*                                            added an option defining    */
/*                                            minimum packet pool payload,*/
...
#ifndef NX_FTP_SERVER_H
#define NX_FTP_SERVER_H
...
#define NX_FTP_SERVER_ID                            0x46545201UL
...
typedef struct NX_FTP_CLIENT_REQUEST_STRUCT
{
    ...
    CHAR            nx_ftp_client_ftp_login;                        /* FTP Login flag                      */
    CHAR            nx_ftp_client_reserved;                         /* Reserved                            */
...
UINT        _nx_ftp_server_create_internal(NX_FTP_SERVER *ftp_server_ptr, CHAR *ftp_server_name, NX_IP *ip_ptr, FX_MEDIA *media_ptr, VOID *stack_ptr, ULONG stack_size, NX_PACKET_POOL *pool_ptr,
                UINT (*ftp_login)(struct NX_FTP_SERVER_STRUCT *ftp_server_ptr, ULONG client_address, UINT client_port, CHAR *name, CHAR *password, CHAR *extra_info),
                UINT (*ftp_logout)(struct NX_FTP_SERVER_STRUCT *ftp_server_ptr, ULONG client_address, UINT client_port, CHAR *name, CHAR *password, CHAR *extra_info));
