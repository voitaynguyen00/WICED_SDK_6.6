...
#ifndef NX_FTP_CLIENT_H
#define NX_FTP_CLIENT_H
...
#define NX_FTP_CLIENT_ID                            0x46545200UL
...
UINT        _nx_ftp_client_connect_internal(NX_FTP_CLIENT *ftp_client_ptr, ULONG server_ip, CHAR *username, CHAR *password, ULONG wait_option);
