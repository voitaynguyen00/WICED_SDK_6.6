...
/*
 * Change for NetX Duo 5.12. The nx_tcp_socket_mss field will only be nonzero if set by the local application
 * and nx_tcp_socket_connect_mss is always set to the MSS of the established connection.
 */
