...
/*                                            in version 5.1              */ 
/*  10-21-2013     Janet Christiansen       Modified comment(s), and      */ 
/*                                            added logic for correct     */
/*                                            handling of multipacket PPP */
/*                                            messages, redefined         */
/*                                            NX_PPP_BASE_TIMEOUT in terms*/
/*                                            of the periodic rate,       */
/*                                            resulting in version 5.2    */ 
/*  01-12-2015     Janet Christiansen       Modified comment(s), and      */ 
/*                                            added support for LCP echo  */ 
/*                                            added support for optional  */
/*                                            DNS option, added a length  */
/*                                            input to the _nx_ppp_hash_  */
/*                                            _generator function,        */
/*                                            resulting in version 5.8    */ 
/*  02-22-2016     Yuxin Zhou               Modified comment(s), and      */
/*                                            unified ticks per second,   */
/*                                            added prototype, enumerated */
/*                                            common naked list options,  */
/*                                            added services to support   */
/*                                            DNS address request options,*/
/*                                            fixed the compiler error if */
/*                                            defined NX_PPP_DISABLE_INFO,*/
...
/*                                            PPP over Ethernet, added    */
/*                                            functions to stop/start PPP,*/
/*                                            resulting in version 5.11   */
/*  08-15-2019     Yuxin Zhou               Modified comment(s), improved */
/*                                            packet length and string    */
/*                                            length verification,        */
