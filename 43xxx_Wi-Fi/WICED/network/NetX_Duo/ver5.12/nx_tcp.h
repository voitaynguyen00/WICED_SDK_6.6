...
/*                                            send reset message on       */
/*                                            receiving illegal option    */
/*                                            length, added support for   */
/*                                            TCP TIMED WAIT state,       */
/*                                            removed unused parameters,  */
/*                                            added declaration for       */
/*                                            sending zero window probe   */
/*                                            and retransmitting packet,  */
/*                                            unified ticks per second,   */
/*                                            defined the TCP minimum     */
/*                                            acceptable MSS, set maximum */
/*                                            TCP receive queue length,   */
/*                                            renamed symbols, exposed    */
/*                                            external functions, added   */
/*                                            missing TCP function        */
/*                                            declarations, resulting in  */
/*                                            version 5.9                 */
/*  05-10-2016     Yuxin Zhou               Modified comment(s), cleaned  */
/*                                            up unused code,added        */
/*                                            symbols for TCP SYN packet, */
