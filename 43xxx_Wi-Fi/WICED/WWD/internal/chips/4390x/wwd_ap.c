...
#define AMPDU_STA_DEFAULT_BA_WSIZE  (16)   /* STA mode default AMPDU block ack window size */
#define AMPDU_AP_DEFAULT_BA_WSIZE   (16)   /* SoftAP mode default AMPDU block ack window size */
