...
/*
 * Updated for ThreadX 5.9. The sample interrupt handlers in tx_initialize_low_level.[sS]
 * have changed. They no longer use _tx_thread_context_save and _tx_thread_context_restore.
 * WICED ThreadX ISR processing has been updated to match.
 */
