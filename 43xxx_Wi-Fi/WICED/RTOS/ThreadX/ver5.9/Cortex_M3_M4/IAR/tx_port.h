...
/*  05-01-2015     William E. Lamie         Modified comment(s), changed  */ 
/*                                            default defines, added      */ 
...
/*                                            IAR libraries, added        */ 
/*                                            logic to remove the need    */ 
/*                                            for context save/restore    */ 
/*                                            calls in ISRs, modified     */ 
/*                                            code for MISRA compliance,  */ 
/*                                            and updated version string, */ 
/*                                            resulting in version 5.6    */ 
/*  03-11-2018     William E. Lamie         Modified comment(s), and      */ 
/*                                            updated version string,     */ 
/*                                            resulting in version 5.7    */ 
/*  09-01-2018     William E. Lamie         Modified comment(s),          */ 
/*                                            optimized lowest set bit    */ 
/*                                            macro, and updated version  */ 
/*                                            string, resulting in        */ 
/*                                            version 5.8                 */ 
/*  03-01-2020     William E. Lamie         Modified comment(s), and      */ 
/*                                            updated version string,     */ 
...
/* WICED: Define the timer ticks per second. */
extern unsigned long host_rtos_get_tickrate( void );
#define TX_TIMER_TICKS_PER_SECOND ( host_rtos_get_tickrate( ) )

/* Define the version ID of ThreadX.  This may be utilized by the application.  */

#ifdef TX_THREAD_INIT
CHAR                            _tx_version_id[] = 
                                    "Copyright (c) 1996-2020 Express Logic Inc. * ThreadX Cortex-M3/IAR Version G5.9.5.9 SN: 4712-108-0901 *";
#else
#ifdef TX_MISRA_ENABLE
