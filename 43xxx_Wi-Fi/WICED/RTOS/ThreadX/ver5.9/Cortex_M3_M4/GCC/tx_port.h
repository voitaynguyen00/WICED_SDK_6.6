...
/*  04-02-2020     William E. Lamie         Modified comment(s),          */ 
...
CHAR                            _tx_version_id[] = 
                                    "Copyright (c) 1996-2020 Express Logic Inc. * ThreadX Cortex-M3/GNU Version G5.9.5.7 SN: 4712-108-0501 *";
#else
