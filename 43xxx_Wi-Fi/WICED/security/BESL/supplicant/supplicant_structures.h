...
typedef struct supplicant_connection_info_
{
    ...
    const uint8_t* trusted_ca_certificates;    /* Root-CA certificate */
    ...
    const uint8_t* eap_identity;               /* EAP identity string, 'null' terminated */

    const uint8_t* user_name;                  /* [Used incase of PEAP and EAP_TTLS] User name string, 'null' terminated */
    const uint8_t* password;                   /* [Used incase of PEAP and EAP_TTLS] Password string, 'null' terminated */
    ...
    const uint8_t* private_key;                /* [Used incase of EAP-TLS] Client private key */
