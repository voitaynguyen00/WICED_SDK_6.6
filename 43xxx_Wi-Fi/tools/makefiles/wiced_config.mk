...
WICED_SDK_VERSION ?=  Wiced_006.006.001.0001
...
$(eval $(NAME)_RESOURCES_EXPANDED := $(foreach res,$($(NAME)_RESOURCES),$(patsubst ./%,%,$(word 1,$(wildcard $(addsuffix $(res),$(CURDIR) $(SOURCE_ROOT)resources/))))))
