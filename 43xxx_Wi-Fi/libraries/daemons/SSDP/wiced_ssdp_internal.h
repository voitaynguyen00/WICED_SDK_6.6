...
#define WICED_SSDP_UUID_MAX                 (36 +1)
...
typedef struct wiced_ssdp_internal_s
{
    ...
    wiced_bool_t                    is_periodic_mcast_notify;   /* after first few quick(in msec) notify msgs, periodic msgs sent with larger(sec) delays */
