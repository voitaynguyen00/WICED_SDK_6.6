...
NAME := Lib_Device_Onboarding

$(NAME)_COMPONENTS := daemons/HTTP_server \
                      daemons/DNS_redirect \
                      libraries/utilities/JSON_parser \

$(NAME)_SOURCES    := device_onboarding.c

#$(NAME)_CFLAGS      = $(COMPILER_SPECIFIC_PEDANTIC_CFLAGS)

#CERTIFICATE := $(SOURCE_ROOT)resources/apps/amqps/amqps_client_cert.cer
#PRIVATE_KEY := $(SOURCE_ROOT)resources/apps/amqps/amqps_client_key.key
