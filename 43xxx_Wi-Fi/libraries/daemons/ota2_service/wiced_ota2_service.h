...
#define WICED_OTA2_HTTPS_PORT                443
...
typedef struct
{
    char*           update_url;             /* URL to check for updates                                     */
    ...
    wiced_config_ap_entry_t*    ota2_ap_info;       /* Alternate AP to use to connect to the OTA2 update server
                                                     ...
                                                     * NOTE: if both ota2_ap_info and ota2_ap_list are NULL, OTA2
                                                     * will use the interface specified in ota2_interface without
 ...
 *             - do the update call (will send appropriate callback events to the application)
