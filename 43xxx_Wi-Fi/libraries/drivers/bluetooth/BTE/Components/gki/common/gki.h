...
/***********************************************************************
** Forward definition of the buffer pool structure
*/
...
GKI_API extern BUFFER_POOL_T GKI_create_pool (UINT16, UINT16, UINT8, void *);
...
extern void wiced_delete_pool(BUFFER_POOL_T *pool);
extern BUFFER_POOL_T * wiced_create_pool(void * p_cfg, UINT32 is_restricted);
extern void * wiced_get_pool_buf(BUFFER_POOL_T * pool);
extern BUFFER_POOL_T* wiced_get_pool(UINT8 pool_id);
BUFFER_POOL_T * wiced_get_max_size_pool(void);
