...
#define wiced_bt_remote_name_cback_t                            tBTM_CMPL_CB
...
#ifdef MPAF_CUSTOM_STACK
/* HCI trace call back */
#define wiced_bt_hci_trace_cback_t                              MPAF_HCI_TRACE_CALLBACK
...
#define wiced_bt_dev_cmpl_cback_t                               tBTM_CMPL_CB
#define wiced_bt_ble_phy_preferences_t                          tBTM_BLE_PHY_PREFERENCES
#define wiced_bt_ble_conn_params_t                              tBTM_BLE_CONN_PARAMS
#define wiced_bt_ble_privacy_mode_t                             tBTM_BLE_PRIVACY_MODE

#define wiced_bt_ble_multi_adv_params_t                         tBTM_BLE_MULTI_ADV_PARAMS
#define wiced_bt_ble_multi_advert_type_t                        tBTM_BLE_MULTI_ADV_TYPE
#define wiced_bt_smp_sc_oob_data_t                              tSMP_SC_OOB_DATA
