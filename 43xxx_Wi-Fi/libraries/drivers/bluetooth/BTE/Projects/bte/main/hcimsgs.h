...
/* ADv extension */
#define HCIC_PARAM_SIZE_BLE_SET_ADV_SET_RANDOM_ADDRESS      7
#define HCIC_PARAM_SIZE_BLE_SET_EXT_ADV_PARAMETERS          25
#define HCIC_PARAM_SIZE_BLE_SET_EXT_ADV_DATA_FIXED          4 //(4 bytes fixed + 0 - 251 bytes data)
#define HCIC_PARAM_SIZE_BLE_SET_EXT_SCAN_RSP_DATA_FIXED     4 //(4 bytes fixed + 0 - 251 bytes data)
#define HCIC_PARAM_SIZE_BLE_SET_EXT_ADV_ENABLE_FIXED        2 //( 1 byte for enable, 1 byte for num of adv set. Depending on num of adv sets cmd param size varies)
#define HCIC_PARAM_SIZE_BLE_READ_MAX_ADV_DATA_LEN           0
#define HCIC_PARAM_SIZE_BLE_READ_NUM_OF_SUP_ADV_SETS        0
#define HCIC_PARAM_SIZE_BLE_REMOVE_ADV_SET                  1
#define HCIC_PARAM_SIZE_BLE_CLEAR_ADV_SETS                  0
#define HCIC_PARAM_SIZE_BLE_SET_PERIODIC_ADV_PARAMS         7
#define HCIC_PARAM_SIZE_BLE_SET_PERIODIC_ADV_DATA_FIXED     3 /* 1 byte for handle, 1 byte for operation, 1 byte for length, remaining variable data len (0-252) */
#define HCIC_PARAM_SIZE_BLE_SET_PERIODIC_ENABLE             2
#define HCIC_PARAMS_SIZE_BLE_SET_EXT_SCAN_PARAMETERS_FIXED  3 /*own addr type, scan filter policy and scanning phy bit mask. variable dpends on bit mask */
#define HCIC_PARAMS_SIZE_BLE_SET_EXT_SCAN_ENABLE            6 /* enable, filter duplicate, duration, period */
#define HCIC_PARAMS_SIZE_BLE_EXT_CREATE_CONN_FIXED          10 /* init fp, own addr type, peer addr type and addr, init phy mask. Variable size depends on phy mask */
#define HCIC_PARAMS_SIZE_BLE_PERIODIC_ADV_CREATE_SYNC       14
#define HCIC_PARAMS_SIZE_BLE_PERIODIC_ADV_CREATE_SYNC_CANCEL    0
#define HCIC_PARAMS_SIZE_BLE_PERIODIC_ADV_TERMINATE_SYNC    2
#define HCIC_PARAMS_SIZE_BLE_ADD_DEV_TO_PERIODIC_ADV_LIST    8
#define HCIC_PARAMS_SIZE_BLE_REMOVE_DEV_FROM_PERIODIC_ADV_LIST  8
#define HCIC_PARAMS_SIZE_BLE_CLEAR_PERIODIC_ADV_LIST            0
#define HCIC_PARAMS_SIZE_BLE_READ_PERIODIC_ADV_LIST_SIZE        0
...
HCI_API extern BOOLEAN btsnd_hcic_ble_read_phy (UINT16 handle, void *p_cmd_cplt_cback);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_default_phy (UINT8 all_phys, UINT8 tx_phys, UINT8 rx_phys);
...
HCI_API extern BOOLEAN btsnd_hcic_ble_set_adv_set_random_address (UINT8 handle, BD_ADDR bd_addr);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_ext_adv_params (UINT8 handle,  UINT16 ev_prop, UINT32 prim_adv_min_int,
                                                            UINT32 prim_adv_int_max, UINT8 prim_adv_chan_map,
                                                            UINT8 own_addr_type, UINT8 peer_addr_type, BD_ADDR peer_addr,
                                                            UINT8 adv_filetr_policy, INT8 adv_tx_power,UINT8 prim_adv_phy,
                                                            UINT8 sec_adv_max_skip, UINT8 sec_adv_phy, UINT8 adv_sid,
                                                            UINT8 scan_req_notify_enable);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_ext_adv_data (UINT8 handle, UINT8 operation, UINT8 host_frag_preference,
                                                            UINT8 data_len, UINT8 *p_adv_data);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_ext_scan_rsp_data (UINT8 handle, UINT8 operation, UINT8 host_frag_preference,
                                                                UINT8 scn_rsp_data_len, UINT8 *scn_rsp_data);
HCI_API extern BOOLEAN btsnd_hcic_ble_enable_ext_adv(UINT8 handle, UINT8 num_of_adv_sets, UINT8 *p_duration_cfg);
HCI_API extern BOOLEAN btsnd_hcic_ble_read_max_adv_data_len (void);
HCI_API extern BOOLEAN btsnd_hcic_ble_read_num_of_supported_adv_sets (void);
HCI_API extern BOOLEAN btsnd_hcic_ble_remove_adv_set (UINT8 handle);
HCI_API extern BOOLEAN btsnd_hcic_ble_clear_adv_sets (void);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_periodic_adv_params(UINT8 handle, UINT16 adv_int_min, UINT16 adv_int_max, UINT16 property);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_periodic_adv_data (UINT8 handle, UINT8 operation, UINT8 len, UINT8 *p_data);

HCI_API extern BOOLEAN btsnd_hcic_ble_set_privacy_mode (UINT8 peer_identity_addr_type, BD_ADDR peer_identity_addr, UINT8 privacy_mode);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_periodic_adv_enable (BOOLEAN enable, UINT8 handle);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_ext_scan_params (UINT8 own_addr_type, UINT8 sfp, UINT8 scan_phy, UINT8 *p_scan_cfg);
HCI_API extern BOOLEAN btsnd_hcic_ble_set_ext_scan_enable (UINT8 enable, UINT8 filter_dup, UINT16 duration, UINT16 period);
HCI_API extern BOOLEAN btsnd_hcic_ble_ext_create_connection (UINT8 init_fp, UINT8 own_addr_type, UINT8 peer_addr_type, BD_ADDR peer_addr,
                                                                UINT8 init_phys, UINT8 *p_data);
HCI_API extern BOOLEAN btsnd_hcic_ble_periodic_adv_create_sync (UINT8 fp, UINT8 sid, UINT8 addr_type, BD_ADDR addr, 
                                                                UINT16 skip, UINT16 sync_to, UINT8 un_used);
HCI_API extern BOOLEAN btsnd_hcic_ble_periodic_adv_create_sync_cancel (void);
HCI_API extern BOOLEAN btsnd_hcic_ble_periodic_adv_terminate_sync (UINT16 sync_handle);
HCI_API extern BOOLEAN btsnd_hcic_ble_add_device_to_periodic_adv_list (UINT8 addr_type, BD_ADDR bda, UINT8 sid);
HCI_API extern BOOLEAN btsnd_hcic_ble_remove_device_from_periodic_adv_list (UINT8 addr_type, BD_ADDR bda, UINT8 sid);
HCI_API extern BOOLEAN btsnd_hcic_ble_clear_periodic_adv_list (void);
HCI_API extern BOOLEAN btsnd_hcic_ble_read_periodic_adv_list_size (void);
#endif /* BLE_INCLUDED */
