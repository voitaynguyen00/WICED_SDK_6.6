...
/* Uncomment below define to enable TX wMaxPacketSize workaround */
#define TX_MPS_POLLING_WORKAROUND

/* Uncomment below define to enable RX wMaxPacketSize workaround */
#define RX_MPS_WORKAROUND
...
#define UX_DCD_BCM4390X_RX_MAX_BULK_PAYLOAD                        512


#define UX_DCD_BCM4390X_HW_EP_UNSET                                0xFF
#define UX_DCD_BCM4390X_HW_DEFAULT_CONTROL_EP                      0
...
typedef struct UX_DCD_BCM4390X_ED_STRUCT
{
    ...
    void            *ux_dcd_bcm4390x_rx_packet;
#ifdef RX_MPS_WORKAROUND
    ULONG           ux_dcd_bcm4390x_ep_bytes;
#endif  /* RX_MPS_WORKAROUND */
} UX_DCD_BCM4390X_ED;
