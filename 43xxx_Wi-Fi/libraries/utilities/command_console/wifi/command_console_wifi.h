...
#else
#ifdef WICED_CONFIG_DISABLE_ENTERPRISE_SECURITY
#define ALL_COMMANDS_ENTERPRISE_SECURITY_COMMANDS
#else
...
#ifdef CONSOLE_ENABLE_WIFI_EXTENDED_COMMANDS_SET
#define ALL_COMMANDS_WIFI_EXTENDED_COMMANDS_SET        WIFI_EXTENDED_COMMANDS_SET
#else
#define ALL_COMMANDS_WIFI_EXTENDED_COMMANDS_SET
#endif


#define WIFI_COMMANDS_LIMITED_SET \
    ALL_COMMANDS_WIFI_EXTENDED_COMMANDS_SET \
    ...
    { (char*) "join",                               join,                               2, NULL, NULL, (char*) "<ssid> <open|wpa_aes|wpa_tkip|wpa2|wpa2_aes|wpa2_tkip|wpa2_fbt|wpa3|wpa3_wpa2> [key] [psk(for wpa3_wpa2 amode only)] [channel] [ip netmask gateway]"ESCAPE_SPACE_PROMPT, (char*) "Join an AP. DHCP assumed if no IP address provided"}, \
    ...
    { (char*) "get_txrx_frag",                      get_txrx_frag,                      0, NULL, NULL, (char*) "",                                              (char*) "Get tx/rx frag counter data."},\
    ...
    { (char*) "channel",                            channel,                            0, NULL, NULL, (char*) "",                                               (char*) "Set/Get the channel number."}, \
    ...
    { (char*) "set_cur_interface",                  set_cur_interface,                  1, NULL, NULL, (char*) "set_cur_interface sta/ap/p2p",            (char*) "set current interface for apps like iperf"}, \
    { (char*) "get_cur_interface",                  get_cur_interface,                  0, NULL, NULL, (char*) "get_cur_interface",                       (char*) "get current interface in use apps like iperf"}, \


#define WIFI_EXTENDED_COMMANDS_SET \
    { (char*) "bw_cap",                             bw_cap,                             1, NULL, NULL, (char*) "",                                           (char*) "Set/Get per band bandwidth."}, \
    { (char*) "mpc",                                mpc,                                0, NULL, NULL, (char*) "",                                           (char*) "Set/Get mpc. 0 = turn off mpc, 1 = mpc with radio off, 2 = mpc with ucode sleep"}, \
    { (char*) "antdiv",                             antdiv,                             0, NULL, NULL, (char*) "",                                           (char*) "Set/Get antdiv."}, \
    { (char*) "2g_rate",                            rate,                               0, NULL, NULL, (char*) "",                                           (char*) "Set/Get 2g_rate."}, \
    { (char*) "5g_rate",                            rate,                               0, NULL, NULL, (char*) "",                                           (char*) "Set/Get 5g_rate."}, \
...
#define WIFI_COMMANDS \
    ...
    { (char*) "start_ap",                           start_ap,                           4, NULL, NULL, (char*) "<ssid> <open|wpa2|wpa2_aes|wep|wep_shared> <key> <channel> <bandwidth> <wps> [ip] [netmask]\n-->When any parameter has spaces, use quotes.\n\tE.g. start_ap \"my ssid\" wpa2 \"my wpa2 key \" 11 20 no_wps 192.168.2.1 255.255.255.0.  Default settings for ip and subnet mask are 192.168.0.1 and 255.255.255.0, or the last ip and subnet specified through this command if applicable.",(char*) "Start AP mode."}, \
    ...
    { (char*) "dltro",                              dhcp_lease_renewal,                 1, NULL, NULL, (char*) "<connect|param|max_dltro> [value-1] .. [value-n]", (char*) "DHCP lease renewal offload"},\
