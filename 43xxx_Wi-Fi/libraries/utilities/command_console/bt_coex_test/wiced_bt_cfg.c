...
{
        .device_name               = (uint8_t*)"LE CoC",/**< Local device name (NULL terminated) */
        //.device_class              = { 0x20, 0x04, 0x1C },        /**< Local device class */
    ...
    .gatt_cfg =                       /**< GATT settings */
    {
         ...
         .max_mtu_size     = 256, /**< Maxiimum MTU size;gki_cfg must have a corresponding buffer pool that can hold this length */
    },
...
/*  { buf_size, buf_count } */
    ...
    { 360,      40  },      /* Large Buffer Pool  (used for HCI ACL messages) */
...
/*  { buf_size, buf_count } */
    ...
    { 512+64, 5},      /* Large Buffer Pool  (used for HCI ACL messages) */
