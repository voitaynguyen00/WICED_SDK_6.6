...
#ifdef CONSOLE_INCLUDE_BT_COEX_TEST
#include "command_console_bt_coex_test.h"
#endif
#ifdef __cplusplus
extern "C" {
#endif
...
#ifdef KPI_METRICS
#define ALL_KPI_HEAP_MEMORY_COMMANDS KPI_HEAP_MEMORY_COMMANDS
#else
#define ALL_KPI_HEAP_MEMORY_COMMANDS
#endif
...
#ifdef CONSOLE_INCLUDE_BT_COEX_TEST
#define ALL_COMMANDS_BT_COEX_TEST_COMMANDS      BT_COEX_TEST_COMMANDS
#else
#define ALL_COMMANDS_BT_COEX_TEST_COMMANDS
#endif
#define ALL_COMMANDS                         \
    ALL_COMMANDS_WIFI_COMMANDS               \
    IPERF_COMMANDS                           \
    ALL_MALLINFO_COMMANDS                    \
    ALL_KPI_HEAP_MEMORY_COMMANDS             \
    PING_COMMANDS                            \
    PLATFORM_COMMANDS                        \
    THREAD_COMMANDS                          \
    ...
    ALL_COMMANDS_BT_COEX_TEST_COMMANDS        \
    FRAM_COMMANDS
