...
typedef enum
{
    APOLLO_STREAMER_EVENT_CONNECTED,                       /*!< no argument                                                                     */
    APOLLO_STREAMER_EVENT_DISCONNECTED,                    /*!< no argument                                                                     */
    APOLLO_STREAMER_EVENT_PLAYBACK_STARTED,                /*!< no argument                                                                     */
    APOLLO_STREAMER_EVENT_PLAYBACK_STOPPED,                /*!< no argument                                                                     */
    APOLLO_STREAMER_EVENT_VOLUME_CHANGED,                  /*!< argument of type @ref apollo_streamer_event_data_t                              */
    APOLLO_STREAMER_EVENT_PLAYBACK_STATUS,                 /*!< argument of type @ref apollo_streamer_event_data_t                              */
    APOLLO_STREAMER_EVENT_TRACK_METADATA,                  /*!< argument of type @ref apollo_streamer_event_data_t                              */
    APOLLO_STREAMER_EVENT_BUFFER_RELEASED,                 /*!< argument of type @ref apollo_streamer_event_data_t                              */
    APOLLO_STREAMER_EVENT_EOS,                             /*!< EXTERNAL audio source only: no argument                                         */
    APOLLO_STREAMER_EVENT_AUDIO_CONFIG_FAILED,             /*!< EXTERNAL audio source only: no argument                                         */
    APOLLO_STREAMER_EVENT_START_FAILED,                    /*!< EXTERNAL audio source only: no argument                                         */
    APOLLO_STREAMER_EVENT_STOP_FAILED,                     /*!< EXTERNAL audio source only: no argument                                         */
