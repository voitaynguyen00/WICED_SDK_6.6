...
typedef wiced_result_t (*wiced_websocket_message_callback_t)( void* websocket, uint8_t* message, uint32_t length,
                        wiced_websocket_frame_type_t frame_type, wiced_websocket_frame_flags_t flags,  uint32_t total_payload_length, int is_data_chunked );
...
typedef struct
{
    ...
    wiced_websocket_message_callback_t  on_chunked_message;
 ...
 *                                 of the  wiced_websocket_t structure
 */
wiced_result_t wiced_websocket_secure_connect( wiced_websocket_t* websocket, const wiced_websocket_client_url_protocol_t* url, wiced_tls_identity_t* tls_identity, const char* root_ca, const char* peer_cn, uint16_t port, wiced_interface_t interface );
 ...
 * @return @ref wiced_result_t
 */
wiced_result_t wiced_websocket_register_callbacks ( wiced_websocket_t* websocket, wiced_websocket_callback_t on_open_callback, wiced_websocket_callback_t on_close_callback, wiced_websocket_message_callback_t on_message_callback, wiced_websocket_callback_t on_error,wiced_websocket_message_callback_t on_chunked_message_callback ) ;
