...
typedef enum
{
    HTTP2_CLIENT_CONFIG_FLAG_SERVER_NAME      = (0x1),
...
typedef enum http_stream_state_e
{
    HTTP_STREAM_STATE_IDLE,
    HTTP_STREAM_STATE_RESERVED_LOCAL,
    HTTP_STREAM_STATE_RESERVED_REMOTE,
    HTTP_STREAM_STATE_OPEN,
    HTTP_STREAM_STATE_HALF_CLOSED_LOCAL,
    HTTP_STREAM_STATE_HALF_CLOSED_REMOTE,
    HTTP_STREAM_STATE_CLOSED,
} http_stream_state_t;
