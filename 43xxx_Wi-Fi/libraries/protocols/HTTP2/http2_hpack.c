...
static wiced_result_t http_hpack_encode_header( http_header_info_t* header, uint8_t** buffer, uint32_t* size )
{
    ...
    {
        /* NOTE: Current implementation uses 'literals without indexing' (INDEX_TABLE_TYPE_LITERAL_WITHOUT_INDEXING) to represent header fields sent in HTTP2 frame(s).
         * If required, this implementation needs to be updated for supporting other forms of header field encoding (Ex: indexed tables).
         */
