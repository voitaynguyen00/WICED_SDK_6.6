...
wiced_result_t amqp_message_get_header(wiced_amqp_buffer_t* ,wiced_amqp_message_header*);
wiced_result_t amqp_message_get_delivery_message_annotations(wiced_amqp_buffer_t* ,void*);
wiced_result_t amqp_message_get_properties( wiced_amqp_buffer_t *, wiced_amqp_message_properties * );
wiced_result_t amqp_message_get_application_properties(wiced_amqp_buffer_t *, wiced_amqp_message_application_properties *);
wiced_result_t amqp_message_get_data(wiced_amqp_buffer_t *, wiced_amqp_message_t * );
