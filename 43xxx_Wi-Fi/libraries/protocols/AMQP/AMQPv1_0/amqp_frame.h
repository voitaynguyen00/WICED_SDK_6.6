...
wiced_result_t  amqp_frame_recv  ( wiced_amqp_buffer_t *buffer, void *p_user, uint32_t *size,uint16_t ,wiced_partial_frame_details_t * );
...
wiced_result_t get_element_pointer(uint8_t**,uint32_t*,wiced_amqp_buffer_t*);
wiced_result_t put_element_pointer(uint8_t*,uint32_t,wiced_amqp_buffer_t*);
wiced_result_t get_element_value(uint64_t*,wiced_bool_t *,wiced_amqp_buffer_t*);
wiced_result_t put_element_value(uint64_t ,wiced_bool_t ,wiced_amqp_buffer_t *);
wiced_result_t put_element_bool(wiced_bool_t value,wiced_bool_t included,wiced_amqp_buffer_t *);
wiced_result_t get_element_bool(wiced_bool_t *value,wiced_bool_t *included,wiced_amqp_buffer_t *);
