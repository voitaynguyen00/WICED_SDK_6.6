...
extern wiced_result_t sntp_start_auto_time_sync_nowait( uint32_t interval_ms );
...
extern wiced_result_t sntp_use_local_server_only(wiced_bool_t flag);
extern wiced_result_t sntp_set_network_interface(wiced_interface_t interface);
