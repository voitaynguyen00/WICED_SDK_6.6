...
/**
 * Connect to a HTTP server. Application should rely on return status of API call to check whether the connection has been established successfully or not.
 *
 * @param[in] client     : HTTP client
