...
static wiced_result_t filex_shim_format           ( wiced_block_device_t* device )
{
    ...
    void*     buffer = PLATFORM_L1_CACHE_PTR_ROUND_UP( (void*)fs_handle.data.filex.buffer ); /* buffer is padded to alignment */
...
static wiced_result_t filex_shim_mount            ( wiced_block_device_t* device, wiced_filesystem_t* fs_handle_out )
{
    ...
    void*     buffer   = (void*)PLATFORM_L1_CACHE_PTR_ROUND_UP( (void*)fs_handle_out->data.filex.buffer ); /* buffer is padded to alignment */
