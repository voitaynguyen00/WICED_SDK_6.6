...
FILEX_LIBRARY_NAME :=$(FILEX_PATH_TO_PREBUILT)/FileX_default.TraceX.$(RTOS).$(HOST_ARCH).release.a
else
# Precompiled library
FILEX_LIBRARY_NAME :=$(FILEX_PATH_TO_PREBUILT)/FileX_default.$(RTOS).$(HOST_ARCH).release.a
endif
