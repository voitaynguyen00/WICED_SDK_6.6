...
FILEX_LIBRARY_NAME :=$(FILEX_PATH_TO_PREBUILT)/FileX_exFAT.TraceX.$(RTOS).$(HOST_ARCH).release.a
else
# Precompiled library
FILEX_LIBRARY_NAME :=$(FILEX_PATH_TO_PREBUILT)/FileX_exFAT.$(RTOS).$(HOST_ARCH).release.a
endif
...
FILEX_DIR_PREFIX := ../
include $(CURDIR)/$(FILEX_DIR_PREFIX)FileX_src.mk
