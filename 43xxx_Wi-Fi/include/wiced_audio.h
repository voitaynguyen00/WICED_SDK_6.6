...
typedef enum
{
    ...
    WICED_AUDIO_IOCTL_GET_WUPD_STREAMING_MODE,
    WICED_AUDIO_IOCTL_SET_WUPD_STREAMING_MODE,
...
typedef struct
{
   wiced_bool_t interrupt_and_stream;
   uint32_t     streaming_timeout;
   int32_t      stream_buffer_start_offset;
   wiced_bool_t buffer_trigger_only;
} wiced_audio_wupd_streaming_mode_t;
...
typedef union
{
    ...
    wiced_audio_wupd_streaming_mode_t wupd_mode;
