...
/** @file
 * Defines board support package for CYW9WCD760PINSDAD2 board
 */
#include "platform.h"
...
const platform_gpio_t platform_gpio_pins[] =
{
    ...
    [WICED_GPIO_11] = { GPIOH,  4 },
    [WICED_GPIO_12] = { GPIOH,  5 },
    [WICED_GPIO_13] = { GPIOA, 13 },
    [WICED_GPIO_14] = { GPIOA, 14 },
    [WICED_GPIO_15] = { GPIOA, 15 },
    [WICED_GPIO_16] = { GPIOB,  3 },
    [WICED_GPIO_17] = { GPIOB,  4 },
    [WICED_GPIO_18] = { GPIOE, 11 },
    [WICED_GPIO_19] = { GPIOG,  9 },
    [WICED_GPIO_20] = { GPIOE,  9 },
    [WICED_GPIO_21] = { GPIOE, 13 },
    [WICED_GPIO_22] = { GPIOG, 14 },
    [WICED_GPIO_23] = { GPIOA, 11 },
    [WICED_GPIO_24] = { GPIOA, 12 },
    [WICED_GPIO_25] = { GPIOC, 9 },  /* gSPI IRQ */
    [WICED_GPIO_26] = { GPIOC, 11 }, /* gSPI CS */
    [WICED_GPIO_27] = { GPIOB, 13 }, /* gSPI CLK */
    [WICED_GPIO_28] = { GPIOB, 15 },  /* gSPI MOSI */
    [WICED_GPIO_29] = { GPIOB, 14 }, /* gSPI MISO */
    [WICED_GPIO_30] = { GPIOF, 14 }  /* gSPI slave power */
...
{
    [WICED_ADC_1] = {ADC1, ADC_Channel_1, RCC_APB2Periph_ADC1, 1, &platform_gpio_pins[WICED_GPIO_4]},
    [WICED_ADC_2] = {ADC1, ADC_Channel_2, RCC_APB2Periph_ADC1, 1, &platform_gpio_pins[WICED_GPIO_3]},
    [WICED_ADC_3] = {ADC1, ADC_Channel_3, RCC_APB2Periph_ADC1, 1, &platform_gpio_pins[WICED_GPIO_2]},
};

/* PWM peripherals. Used by WICED/platform/MCU/wiced_platform_common.c */
const platform_pwm_t platform_pwm_peripherals[] =
{
    [WICED_PWM_1]  = {TIM2, 2, RCC_APB1Periph_TIM2, GPIO_AF_TIM2, &platform_gpio_pins[WICED_GPIO_2] }, /* or TIM5/Ch2                       */
    [WICED_PWM_2]  = {TIM2, 3, RCC_APB1Periph_TIM2, GPIO_AF_TIM2, &platform_gpio_pins[WICED_GPIO_3] }, /* or TIM5/Ch3, TIM9/Ch1             */
    [WICED_PWM_3]  = {TIM2, 4, RCC_APB1Periph_TIM2, GPIO_AF_TIM2, &platform_gpio_pins[WICED_GPIO_4] }, /* or TIM5/Ch4, TIM9/Ch2             */
    [WICED_PWM_4]  = {TIM2, 1, RCC_APB1Periph_TIM2, GPIO_AF_TIM2, &platform_gpio_pins[WICED_GPIO_6] }, /* or TIM2_CH1_ETR, TIM8/Ch1N        */
    [WICED_PWM_5]  = {TIM3, 1, RCC_APB1Periph_TIM3, GPIO_AF_TIM3, &platform_gpio_pins[WICED_GPIO_7] }, /* or TIM1_BKIN, TIM8_BKIN, TIM13/Ch1*/
    [WICED_PWM_6]  = {TIM3, 2, RCC_APB1Periph_TIM3, GPIO_AF_TIM3, &platform_gpio_pins[WICED_GPIO_8] }, /* or TIM8/Ch1N, TIM14/Ch1           */
};
    ...
    [WICED_SPI_2]  =
        {
            ...
            .peripheral_clock_func = RCC_APB2PeriphClockCmd,
            .pin_mosi              = &platform_gpio_pins[WICED_GPIO_28],
            .pin_miso              = &platform_gpio_pins[WICED_GPIO_29],
            .pin_clock             = &platform_gpio_pins[WICED_GPIO_27],
            .tx_dma =
            {
                .controller        = DMA1,
                .stream            = DMA1_Stream4,
...
const platform_uart_t platform_uart_peripherals[] =
{
    [WICED_UART_1] =
    {
        ...
        .cts_pin            = &platform_gpio_pins[WICED_GPIO_23],
        .rts_pin            = &platform_gpio_pins[WICED_GPIO_24],
        .tx_dma_config =
        {
            .controller     = DMA2,
            .stream         = DMA2_Stream7,
...
static const platform_gpio_t internal_bt_control_pins[] =
{
    ...
    [WICED_BT_PIN_HOST_WAKE  ] = { GPIOF,  9 },
...
const gpio_button_t platform_gpio_buttons[PLATFORM_BUTTON_MAX] =
{
    ...
    {
        .gpio       = WICED_BUTTON1,
        .config     = INPUT_HIGH_IMPEDANCE,     /* Not able to find on schematic - play it safe */
        .polarity   = WICED_ACTIVE_LOW,         /* Not able to find on schematic */
...
{
    /* Initialise LEDs and turn 1 on, rest off by default */
