...
const gpio_button_t platform_gpio_buttons[PLATFORM_BUTTON_MAX] =
{
    ...
    {
        .gpio       = WICED_BUTTON1,
        .config     = INPUT_PULL_UP,            /* No External pull up on board USER_1 (SW3) PIN_PWM_5 */
    ...
    {
        .gpio       = WICED_BUTTON2,
        .config     = INPUT_HIGH_IMPEDANCE,            /* No External pull up on board USER_2 (SW1) PIN_GPIO_8 */
        .polarity   = WICED_ACTIVE_LOW,
        .trigger    = IRQ_TRIGGER_BOTH_EDGES,
    }
};
...
void platform_init_external_devices( void )
{
    ...
    /* Initialize buttons
     * NOTE: On this platform, the buttons MUST be initialized in this order.
     */
