...
const platform_gpio_t platform_gpio_pins[] =
{
    ...
    [WICED_GPIO_20] = { GPIOC,  0 },    /* Config for user SPI2_IRQ */
    ...
    [WICED_GPIO_28] = { GPIOB, 12 },    /* MICRO_SPI2_SSN */
    [WICED_GPIO_29] = { GPIOB, 13 },    /* MICRO_SPI2_SCK */
    [WICED_GPIO_30] = { GPIOB, 14 },    /* MICRO_SPI2_MISO */
    [WICED_GPIO_31] = { GPIOB, 15 },    /* MICRO_SPI2_MOSI */
};
