...
NAME := Platform_CYW943012EVB_04

WLAN_CHIP            := 43012
WLAN_CHIP_REVISION   := C0
WLAN_CHIP_FAMILY     := 43012
HOST_MCU_FAMILY      := STM32L4xx
HOST_MCU_VARIANT     := STM32L4A6
HOST_MCU_PART_NUMBER := STM32L4A6VGT6
