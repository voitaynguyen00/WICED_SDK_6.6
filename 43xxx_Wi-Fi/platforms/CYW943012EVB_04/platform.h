...
/** @file
 * Defines peripherals available for use on CYW943012EVB_04 board
 */
#pragma once
...
#define WICED_GPIO_AUTH_RST ( WICED_GPIO_ )

/* SPI flash is present */
/* Default placeholder, to be defined per platform */
/* #define WICED_PLATFORM_INCLUDES_SPI_FLASH */
#define WICED_SPI_FLASH_CS ( WICED_GPIO_NONE )

/* Components connected to external I/Os */
/* Default placeholder, to be defined per platform */
#define PLATFORM_LED_COUNT  ( 3 )
#define WICED_LED1          ( WICED_GPIO_60 )
#define WICED_LED2          ( WICED_GPIO_56 )
#define WICED_LED3          ( WICED_GPIO_17 )
#define WICED_LED1_ON_STATE ( WICED_ACTIVE_HIGH )
#define WICED_LED2_ON_STATE ( WICED_ACTIVE_HIGH )


#define WICED_PLATFORM_BUTTON_COUNT  ( 3 )
#define WICED_BUTTON1       ( WICED_GPIO_19 )
#define WICED_BUTTON2       ( WICED_GPIO_46 )
#define WICED_BUTTON3       ( WICED_GPIO_26 )
