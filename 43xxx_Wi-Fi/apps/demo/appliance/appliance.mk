...
# Disable TLS to reduce memory footprint and fits to this platform
#
# Application requires more HEAP than the default 30KB HEAP defined
# by the platform

GLOBAL_DEFINES += WICED_DISABLE_TLS PLATFORM_HEAP_SIZE=40*1024 APPLICATION_STACK_SIZE=10*1024
endif
