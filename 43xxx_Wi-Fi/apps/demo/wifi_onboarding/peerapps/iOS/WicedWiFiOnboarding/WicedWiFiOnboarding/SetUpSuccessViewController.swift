...
protocol SetUpSuccessViewControllerDelegate {
    func beginOnboarding()
}

class SetUpSuccessViewController: UIViewController {

    var delegate: SetUpSuccessViewControllerDelegate?
