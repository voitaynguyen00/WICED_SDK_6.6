...
#define MESH_URIS \
    ...
    { "/mesh/subscribe/sse",            "application/json",  WICED_RAW_DYNAMIC_URL_CONTENT, .url_content.dynamic_data = { subscribe_sse_events,      0 }, }, \
    { "/mesh/connect",                  "application/json",  WICED_RAW_DYNAMIC_URL_CONTENT, .url_content.dynamic_data = { connect_network,           0 }, }, \
    { "/mesh/disconnect",               "application/json",  WICED_RAW_DYNAMIC_URL_CONTENT, .url_content.dynamic_data = { disconnect_network,        0 }, },
...
wiced_result_t mesh_send_status (uint8_t* val, int len );
