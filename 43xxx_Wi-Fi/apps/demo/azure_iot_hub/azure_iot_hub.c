...
#define AMQP_BROKER_IP_ADDRESS          "WICED.azure-devices.net"
#define AMQP_HOST_NAME                  "WICED.azure-devices.net"
#define AMQP_SASL_PLAIN_USER_NAME       "iothubowner@sas.root.WICED"
...
#define AMQP_SASL_PLAIN_USER_PASSWORD   "SharedAccessSignature sr=WICED.azure-devices.net&sig=LFtoxL9JEka4akdUMnqZpbmC7cLTSzNWoi6jbQ99zHw%3D&se=1556173400&skn=iothubowner"
#define AMQP_SENDER_LINK_TARGET_ADDRESS "/devices/wiced_device/messages/events"
...
static wiced_result_t amqp_attach_link( wiced_amqp_link_instance* link_instance, wiced_amqp_session_instance_t* session_instance, char *source, char *target, wiced_amqp_role_types_t role )
{
    ...
    link_instance->link_args.source.address = (uint8_t*) source;
    link_instance->link_args.target.address = (uint8_t*) target;
