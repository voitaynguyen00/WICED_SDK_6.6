...
typedef struct
{
    ...
    char                      thing_name[ AWS_THING_NAME_MAX_LENGTH ];
...
void application_start( void )
{
    ...
    free(my_smart_device_aws_config.credentials->certificate);
    free(my_smart_device_aws_config.credentials->private_key);
