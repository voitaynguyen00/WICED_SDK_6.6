...
extern int ca_get_version                ( int argc, char *argv[] );
...
extern int sta_set_security              ( int argc, char *argv[] );
...
extern int sta_scan                      ( int argc, char *argv[] );
...
extern int wicedlog_read                 ( int argc, char* argv[] );
extern int wiced_scan                    ( int argc, char *argv[] );
extern int wiced_status                  ( int argc, char *argv[] );
...
#define WIFI_CERT_COMMANDS \
    ...
    { "ca_get_version",                  ca_get_version,                            0,         NULL, NULL, "", "" }, \
    ...
    { "sta_set_security",                sta_set_security,                          1,         NULL, NULL, "", "" }, \
    ...
    { "wicedlog",                        wicedlog_read,                             0,         NULL, NULL, "", " "}, \
    { "scan",                            wiced_scan,                                0,         NULL, NULL, "", " "}, \
    { "status",                          wiced_status,                              0,         NULL, NULL, "", " "}, \
