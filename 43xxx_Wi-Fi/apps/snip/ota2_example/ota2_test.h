...
typedef enum {
    ...
    PLAYER_EVENT_FACTORY_RESET_NOW    = (1 <<  8),
    PLAYER_EVENT_FACTORY_RESET_FAILSAFE= (1 <<  9),
    PLAYER_EVENT_FACTORY_RESET_REBOOT = (1 << 10),
    PLAYER_EVENT_FACTORY_RESET_STATUS = (1 << 11),

    PLAYER_EVENT_UPDATE_NOW           = (1 << 12),
    PLAYER_EVENT_UPDATE_FAILSAFE      = (1 << 13),
    PLAYER_EVENT_UPDATE_REBOOT        = (1 << 14),
    PLAYER_EVENT_UPDATE_STATUS        = (1 << 15),

    PLAYER_EVENT_RELOAD_DCT_WIFI      = (1 << 16),
    PLAYER_EVENT_RELOAD_DCT_NETWORK   = (1 << 17),
