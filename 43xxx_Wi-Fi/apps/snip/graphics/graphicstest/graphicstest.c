 ...
 *
 *   For 128x64 ssd1306 OLED displays with CYW943907AEVAL1F Eval board:
 *     Attach the display to the WICED Eval board such that:
 *       - VCC goes to 3.3V power (J9 pin 4)
 *       - GND goes to ground     (J9 pin 6 or 7)
 *       - SCL goes to I2C_1_SCL  (J12 pin 10)
 *       - SDA goes to I2C_1_SDA  (J12 pin 9)
 *
