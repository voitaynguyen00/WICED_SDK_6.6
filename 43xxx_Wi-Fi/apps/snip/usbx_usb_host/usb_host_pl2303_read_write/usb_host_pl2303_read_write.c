...
static void pl2303_get_file_rx_callback( UX_HOST_CLASS_PROLIFIC *prolific, UINT status, UCHAR *reception_buffer, ULONG reception_size )
{
    ...
    mbedtls_sha1_update_ret( &prolific_sha1_ctx, (unsigned char *)prolific_global_reception_buffer, prolific_global_reception_size );
}
...
int usb_host_app_pl2303_get_file( int argc, char* argv[] )
{
    ...
    mbedtls_sha1_starts_ret( &prolific_sha1_ctx );
    ...
    while ( 1 )
    {
        ...
        {
            mbedtls_sha1_finish_ret( &prolific_sha1_ctx, (unsigned char *)prolific_hash_value );
