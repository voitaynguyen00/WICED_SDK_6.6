...
static void cdc_acm_get_file_rx_callback( UX_HOST_CLASS_CDC_ACM *cdc_acm, UINT status, UCHAR *reception_buffer, ULONG reception_size )
{
    ...
    mbedtls_sha1_update_ret( &cdc_acm_sha1_ctx, (unsigned char *)cdc_acm_global_reception_buffer, cdc_acm_global_reception_size );
}
...
int usb_host_app_cdc_acm_get_file( int argc, char* argv[] )
{
    ...
    mbedtls_sha1_starts_ret( &cdc_acm_sha1_ctx );
    ...
    while ( 1 )
    {
        ...
        {
            mbedtls_sha1_finish_ret( &cdc_acm_sha1_ctx, (unsigned char *)cdc_acm_hash_value );
