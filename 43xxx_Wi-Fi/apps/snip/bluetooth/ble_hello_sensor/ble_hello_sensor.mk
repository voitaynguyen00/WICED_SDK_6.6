...
ifeq ($(PLATFORM),$(filter $(PLATFORM),CYW943907WAE4 CYW943907WAE3 CYW943012P6EVB_01))
...
# IWA platform doesnt support BT LOWER POWER API's
ifneq ($(PLATFORM),$(filter $(PLATFORM), CYW9MCU7X9N364))
GLOBAL_DEFINES += WICED_BT_LOW_POWER_API_SUPPORTED=1
endif
...
VALID_PLATFORMS    = CYW943907WAE3 BCM943907WCD2 CYW9WCD2REFAD2.CYW943012A0FCREF_3 CYW9WCD760PINSDAD2 CYW943907WAE4 CYW943012P6EVB_01
